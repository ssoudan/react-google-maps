...
var _eventListsHeatmapEventList = require("../eventLists/HeatmapEventList");

var _eventListsHeatmapEventList2 = _interopRequireDefault(_eventListsHeatmapEventList);
...
var heatmapControlledPropTypes = {
...
exports.heatmapControlledPropTypes = heatmapControlledPropTypes;
var heatmapDefaultPropTypes = (0, _utilsDefaultPropsCreator2["default"])(heatmapControlledPropTypes);

exports.heatmapDefaultPropTypes = heatmapDefaultPropTypes;
var heatmapUpdaters = {
    options: function options(_options, component) {
        component.getHeatmap().setOptions(_options);
    },
    data: function data(_data, component) {
        component.getHeatmap().setData(_data);
    }
};

var _eventHandlerCreator = (0, _utilsEventHandlerCreator2["default"])(_eventListsHeatmapEventList2["default"]);

var eventPropTypes = _eventHandlerCreator.eventPropTypes;
var registerEvents = _eventHandlerCreator.registerEvents;
var heatmapEventPropTypes = eventPropTypes;

exports.heatmapEventPropTypes = heatmapEventPropTypes;

var HeatmapCreator = (function (_Component) {
    _inherits(HeatmapCreator, _Component);

    function HeatmapCreator() {
        _classCallCheck(this, _HeatmapCreator);

        _get(Object.getPrototypeOf(_HeatmapCreator.prototype), "constructor", this).apply(this, arguments);
    }

    _createClass(HeatmapCreator, [{
        key: "getHeatmap",
        ...
        key: "_createHeatmap",
        value: function _createHeatmap(mapHolderRef, heatmapProps) {
            // https://developers.google.com/maps/documentation/javascript/3.exp/reference#Heatmap
            var heatmap = new google.maps.visualization.HeatmapLayer((0, _utilsComposeOptions2["default"])(heatmapProps, [
        ...
        value: {
            ...
            heatmap: _react.PropTypes.object.isRequired
        },
        enumerable: true
    }]);

    var _HeatmapCreator = HeatmapCreator;
    HeatmapCreator = (0, _utilsComponentLifecycleDecorator2["default"])({
        registerEvents: registerEvents,
        instanceMethodName: "getHeatmap",
        updaters: heatmapUpdaters
    })(HeatmapCreator) || HeatmapCreator;
    return HeatmapCreator;
})(_react.Component);

exports["default"] = HeatmapCreator;